...
$usertotals = array(); // array[name] -> int
...
function totalhours($days, $start, $end){
    $total = 0;
    foreach($days as $day){
...
foreach($shiftfiles as $file){
    ...
    $usertotals[$jsonobj["Name"]] = totalhours($jsonobj["Shift"], START, END);
}
...
<?php
                ...
                foreach($usernames as $user){
                    ...
                    echo "<div class='one-third column'><table style='width:100%'><tr><td class='hour' id='worker$id'>{$total}</td><td class='crop name'>$user</td></tr></table></div>";
                    if ($id % 3 == 0){echo "</div>"; }
                    $id++;
                }
